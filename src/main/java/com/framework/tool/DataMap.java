//Developed by @mario 1.2.20220709
...
public class DataMap {
	...
	public Object get(String key, Object defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : ret;
	}
	...
	public String getString(String key, String defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : String.valueOf(ret);
	}
	public int getInt(String key) {
		return getInt(key, 0);
	}
	public int getInt(String key, int defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : Integer.parseInt(String.valueOf(ret));
	}
	public Long getLong(String key) {
		return getLong(key, 0);
	}
	public Long getLong(String key, long defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : Long.parseLong(String.valueOf(ret));
	}
	public Float getFloat(String key) {
		return getFloat(key, 0);
	}
	public Float getFloat(String key, float defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : Float.parseFloat(String.valueOf(ret));
	}
	public Double getDouble(String key) {
		return getDouble(key, 0);
	}
	public Double getDouble(String key, double defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : Double.parseDouble(String.valueOf(ret));
	}
	public BigDecimal getDecimal(String key) {
		return getDecimal(key, BigDecimal.valueOf(0));
	}
	public BigDecimal getDecimal(String key, BigDecimal defaultVaue) {
		Object ret = this.data.get(key);
		return ret == null ? defaultVaue : new BigDecimal(String.valueOf(ret));
	}
	...
	public static Object dataToMap(Object obj) {
		...
		if (obj instanceof JSONArray) {
			List<Object> items = ((JSONArray) obj).toJavaList(Object.class);
			List<Object> list = new ArrayList<>();
			for (Object item : items) list.add(dataToMap(item));
			return list;
		} else if (obj instanceof JSONObject) {
			Map<String, Object> data = ((JSONObject)obj).getInnerMap();
			...
			List<DataMap> items = ((DataList) obj).list;
			List<Object> list = new ArrayList<>();
			for (Object item : items) list.add(dataToMap(item));
			return list;
